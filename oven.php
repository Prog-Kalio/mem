...
<!-- Row 4 -->
		<div class="inb-div"><h6>RELATED PRODUCTS</h6></div>
			...
			<div class="row cnt-row" id="rel-prod">
				<div class="col-md-3 related equipment" id="rel-prod1">					<img src="images/tonorel1.png" class="img-fluid" alt="Keeler NCT desktop" id="keelerdsk" width="250" height="250">
					<p><b>Tonometer</b></p>
